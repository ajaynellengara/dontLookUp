...
<div id="pageWrapper" class="coursePage lifeDlu">
    <section id="InnerBanner">
        <picture>
            <source rel="preload" srcset="assets/images/banner-lifeDlu-1.jpg" media="(min-width:768px)" width="1920"
                height="1080">
            <img rel="preload" src="assets/images/banner-lifeDlu-1.jpg" width="640" height="360" alt="course"
                fetchpriority="low" loading="lazy" decoding="async">
        </picture>
        <div class="container">
            <div class="cntWrap">
                <h1 class="mTxt">Life at DLU</h1>
                <h2 class="mHead">Experience Growth & <br>
    ...
    <section id="CourseInfo">
        <div class="container">
            <div class="academyWrap">
                ...
                <div class="txtWrap">
                    <h5>A vibrant community where creativity thrives! Engage in workshops, networking events, and
                        cultural celebrations, fostering connections and personal growth. Experience inspiration and
                        empowerment every day at DLU!</h5>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="ExGallery">
        <div class="container">
            <div class="tleWrap center">
                <h6 class="mTxt">Explore Our Gallery</h6>
                <h4 class="mHd">Discover the Essence <br> of Creativity</h4>
            </div>
            <div class="swiper exGallerySlide">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <a href="assets/images/exGallery-og-1.jpg" data-fancybox="exGallery" class="exGalleryBx sm">
                            <img src="assets/images/exGallery-og-1.jpg" width="376" height="476" loading="lazy"
                                alt="experise">
                        </a>
                    </div>
                    <div class="swiper-slide">
    ...
    <section id="VibrantCommunity">
        <div class="container">
            <div class="dFlx">
                <div class="lftSd">
                    <div class="cntWrap">
                        <div class="tleWrap">
                            <h6 class="mTxt">Join the Community</h6>
                            <h4 class="mHd">Become Part of Our Vibrant Community!.</h4>
                        </div>
                        <p>Join a diverse group of passionate individuals who share your <br> interests and aspirations.
                            Connect, collaborate, and grow <br> together through engaging events, resources, and
                            support.<br> Your journey starts here!</p>
                        <div class="btnWrap">
                ...
                <div class="rgtSd">
                    <div class="imgOuter">
                        <div class="imgWrap">
                            <img src="assets/images/exGallery-ognw-1.jpg" width="440" height="720" loading="lazy"
                                alt="exGallery">
                        </div>
                        <div class="delmt_img1">
                            <img src="assets/images/exGallery-ognw-2.jpg" width="440" height="720" loading="lazy"
                                alt="exGallery">
                        </div>
                        <div class="delmt_img2">
                            <img src="assets/images/exGallery-ognw-3.jpg" width="440" height="720" loading="lazy"
                                alt="exGallery">
                        </div>
                    </div>
                </div>
