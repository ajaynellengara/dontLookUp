...
<div id="pageWrapper" class="aboutPage">
    ...
    <section id="AboutInfo">
        <div class="container">
            ...
            <div class="trainingBx">
                <img src="assets/images/training-1.jpg" width="1200" height="700" loading="lazy" alt="about">
                <div class="lftSd">
                    <div class="tleWrap">
                        <h3 class="mHd">DLU TRAINING METHODOLOGY</h3>
                    </div>
                </div>
                <div class="rgtSd">
                    <ul class="infoUl">
                        <li>INDUSTRY RELEVANT</li>
                        <li>EXPERIENCE TRANSFER APPROACH</li>
            ...
            <div class="joinBx">
                <img src="assets/images/join-1.jpg" width="1200" height="576" loading="lazy" alt="join">
                <div class="bxCnt ckCntWrap">
            ...
            <div class="miviFlx">
                <div class="item">
                    <div class="miviBx">
                        <div class="bxCnt">
                            <div class="tle">Vision</div>
                            <div class="txt">To be the leading provider of Direct skill education in the industry.</div>
                        </div>
                        <div class="bxImg">
                            <img src="assets/images/icon-eye.svg" width="140" height="140" loading="lazy" alt="eye">
                        </div>
                    </div>
                </div>
                <div class="item">
    ...
    <section id="OurTeam">
        <div class="container">
            <div class="tleWrap center">
                <h4 class="mHd">Our Team</h4>
            </div>
            <div class="swiper teamSlide">
    ...
    <section id="OurPartners">
        <div class="container">
            <div class="tleWrap center">
                <h4 class="mHd">Our Partners</h4>
            </div>
            <div class="swiper ourPartnersSlide">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
