                        ...
                        <div class="accordion-item">
                            <div class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    <span class="ftTle">About us</span>
                                </button>
                            </div>
...
<!-- <ul id="fixedRgt">
    ...
    <li class="call">
        <a href="tel:+000" target="_blank" aria-label="call">
            <img alt="Call icon" class="lazy" width="40" height="40" data-src="assets/images/icon-call.svg">
        </a>
    </li>
    <li class="mail">
        <a href="mailto:info@000.com" target="_blank" aria-label="mail">
